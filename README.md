...
Для интеграции с Telegram создан Python бот, который отправляет приветственное сообщение с кнопкой для запуска мини-приложения.
...
2. **Настройте переменные окружения:**
   ```bash
   cp telegram-bot/config.example telegram-bot/.env
   # Отредактируйте .env файл и добавьте ваш токен от BotFather
   ```
...
Подробная документация: [telegram-bot/README.md](telegram-bot/README.md)
