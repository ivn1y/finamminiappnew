...
export const globalBadges: Badge[] = [
  ...
  { 
    id: 'explorer', 
    title: 'Исследователь', 
    tooltip: 'Первый шаг в Коллаб сделан',
...
export const roleContent: RoleContent[] = [
  {
    ...
    pushes: [
      ...
      'Сегодня твой день: протестируй стратегию в Коллаб →'
    ]
  },
  {
    id: 'startup',
  ...
  },
  {
    ...
    firstQuest: {
      title: 'Выбор роли',
      desc: 'Кем ты хочешь быть в Коллаб — ментором или трекером?',
  ...
  },
  {
    ...
    badges: [
      ...
      { 
        id: 'builder', 
        title: 'Builder', 
        tooltip: 'Запустил новый продукт с Коллаб',
        howToEarn: 'Запусти свой продукт в витрине Коллаб и получи первые пользователей'
      },
      { 
        id: 'visionary', 
        title: 'Visionary', 
    ...
    pushes: [
      ...
      'Присоединись к витрине продуктов Коллаб →'
    ]
  },
  {
    id: 'guest',
    ...
    goals7d: [
      'Изучить платформу Коллаб',
      'Познакомиться с сообществом',
      'Найти интересные проекты'
    ],
    firstQuest: {
      title: 'Знакомство с платформой',
      desc: 'Изучи основные возможности Коллаб и выбери интересующее направление.',
    ...
    badges: [
      { 
        ...
        howToEarn: 'Изучи все основные разделы платформы Коллаб'
      },
      { 
        id: 'observer', 
        title: 'Observer', 
...
export const chatIntents: ChatIntent[] = [
  {
    id: 'what-is-collab',
    title: 'Что такое Коллаб?',
    response: 'Финам Коллаб — это пространство для трейдеров, стартапов и экспертов. Здесь можно запускать стратегии, пилоты и влиять на рынок.'
  },
  {
    id: 'ai-assistant',
    title: 'FAQ',
    response: 'FAQ поможет вам разобраться с платформой Коллаб, ответит на вопросы о возможностях для трейдеров, стартапов, экспертов и партнёров. Просто задайте вопрос или выберите интересующую тему из быстрых кнопок.'
  },
  {
    id: 'trader-program',
...
export const scheduleData: ScheduleData = {
  events: [
    ...
    },
    {
      ...
      description: 'Возможности для трейдера: запуск фонда, автоследование, агентские программы, Финам Коллаб',
      format: 'Выступление',
      speakers: ['Igor Fox'],
      block: 'Блок 2: Обзор стратегий и тактик'
    },
    ...
    },
    {
      ...
      time: '14:25 - 14:55',
      title: 'Финам Коллаб: новые возможности с надежным партнером',
      format: 'Панель',
