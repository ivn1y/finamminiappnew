      ...
      <div className="w-full min-h-full flex flex-col px-[20px]">
        ...
        <div className="flex justify-center pt-[48px]">
          <div className="w-[150px] h-[150px] relative flex-shrink-0">
            <img
              src="/assets/products/mezhdunarodnyerinki.png"
        ...
        <button 
          onClick={() => window.open('https://telegra.ph/Mezhdunarodnaya-torgovlya-10-28', '_blank')}
        ...
        <button 
          onClick={() => window.open('https://t.me/alex_irish', '_blank')}
