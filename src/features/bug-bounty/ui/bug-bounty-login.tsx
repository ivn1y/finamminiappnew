...
export function BugBountyLogin({ onBack, onSuccess, onGoRegister }: Props) {
  ...
  return (
    <div
      className="fixed inset-0 flex items-center justify-center overflow-hidden bg-black text-white pb-[12%] md:pb-0 md:py-12"
      style={{ touchAction: 'none' }}
    >
      <div
        className="pointer-events-none absolute left-[55px] top-[101px] z-0 h-[205px] w-[284px] rounded-[284px] opacity-[0.38] blur-[80px] md:left-1/2 md:top-1/3 md:h-[280px] md:w-[480px] md:-translate-x-1/2 md:opacity-25"
        style={{
      ...
      <div className="relative z-10 w-full max-w-[393px] px-5 md:max-w-[480px] md:rounded-2xl md:border md:border-white/10 md:bg-[#0c0c0e] md:p-10 md:shadow-[0_0_0_1px_rgba(255,255,255,0.04),0_24px_80px_rgba(0,0,0,0.55)] lg:max-w-[520px]">
